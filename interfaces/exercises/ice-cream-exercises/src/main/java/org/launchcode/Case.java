...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("nuts",1, new ArrayList<>(Arrays.asList("")));
        Topping topping2 = new Topping("sprinklers", 0.76, new ArrayList<>(Arrays.asList("","")));
        Topping topping3 = new Topping("Fudge", 1.2, new ArrayList<>(Arrays.asList("","","")));
